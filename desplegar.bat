...
REM
REM  Enlace bueno: https://amanda.creskio.com
REM ============================================================
cd /d "E:\Escritorio\DEMOS ESTETICAS\Amanda Medina Centro Estetica"

echo.
echo  Publicando Amanda Medina
echo  --------------------------------------------
echo.
